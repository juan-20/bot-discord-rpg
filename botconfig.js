module.exports = {
  ...
  Token: process.env.Token || "MTA2MTc4NTYzNTIwNTE1NjkyNA.GPBuPQ.Lw_BlaQLz2WYvBskcLqkwH6MYd9T0m3myIw0is", // Discord Bot Token
  ClientID: process.env.Discord_ClientID || "1061785635205156924", // Discord Client ID
  ClientSecret: process.env.Discord_ClientSecret || "r2CqDXU6XUiT-ZzQs-3hVIZtja77Eu2l", // Discord Client Secret
  ...
  Spotify: {
    ClientID: process.env.Spotify_ClientID || "1198bdac074c438680a27443523c0b88", // Spotify Client ID
    ClientSecret: process.env.Spotify_ClientSecret || "5a5fd60690454093ba18537af1cb1599", // Spotify Client Secret
  },
};
